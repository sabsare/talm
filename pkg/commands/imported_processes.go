// Code generated by go run tools/import_commands.go --talos-version v1.10.4 processes
// DO NOT EDIT.
...
func init() {
	processesCmd.Flags().StringSliceVarP(&processesCmdFlags.configFiles,
		"file", "f", nil, "specify config files or patches in a YAML file (can specify multiple)",
	)
	processesCmd.PreRunE = func(cmd *cobra.Command,
		...
		endpointsFromArgs := len(GlobalArgs.
			Endpoints) > 0
		for _, configFile := range processesCmdFlags.configFiles {
