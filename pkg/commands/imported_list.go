// Code generated by go run tools/import_commands.go --talos-version v1.10.4 ls
// DO NOT EDIT.
...
func init() {
	lsCmd.Flags().StringSliceVarP(&lsCmdFlags.configFiles, "file",
	...
	lsCmd.PreRunE = func(cmd *cobra.Command, args []string) error {
		...
		endpointsFromArgs := len(
			GlobalArgs.Endpoints,
		) > 0

		for _, configFile := range lsCmdFlags.configFiles {
