// Code generated by go run tools/import_commands.go --talos-version v1.10.4 pcap
// DO NOT EDIT.
...
func init() {
	pcapCmd.Flags().StringSliceVarP(&pcapCmdFlags.configFiles, "file",
		"f", nil, "specify config files or patches in a YAML file (can specify multiple)",
	)
	pcapCmd.PreRunE = func(cmd *cobra.Command,
		...
		endpointsFromArgs := len(GlobalArgs.
			Endpoints) > 0
		for _, configFile := range pcapCmdFlags.configFiles {
